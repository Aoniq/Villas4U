...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./assets/img/huis1.jpg" class="d-block w-100 img-fluid" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./assets/img/huis1-2.jpg" class="d-block w-100 img-fluid" alt="...">
    </div>
    <div class="carousel-item">
      <img src="./assets/img/huis1-3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
                ...
                <div class="mt-3">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="bod">
                            </div>
                        </div>
